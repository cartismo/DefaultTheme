                            ...
                            >
                                ...
                                >
                                    ...
                                    <Link href="/account" class="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50">
                                        <HomeIcon class="w-5 h-5 mr-3 text-gray-400" />
                                        {{ t('account.dashboard') }}
                                    </Link>
                                    ...
                                    <div class="max-h-96 overflow-y-auto">
                                        ...
                                        >
                                            <div class="flex items-start gap-3">
                                                ...
                                                >
                                                    <ShoppingBagIcon v-if="notification.icon === 'shopping-bag'" class="w-5 h-5" />
                                                    <TruckIcon v-else-if="notification.icon === 'truck'" class="w-5 h-5" />
